...
@SpringBootTest(classes = { MissionController.class })
@ContextConfiguration(classes = {SecurityTestConfig.class})
public class MissionControllerTest extends AbstractControllerTest {

    private static final String INTERGALACTIC_MISSION_ENDPOINT = "/api/missions";
    ...
    public void createShouldReturn201() throws Exception {
        ...
        MockHttpServletResponse response = doRequest(INTERGALACTIC_MISSION_ENDPOINT, HttpMethod.POST, createJson(mission));
    ...
    public void updateShouldReturn200() throws Exception {
        ...
        MockHttpServletResponse response = doRequest(INTERGALACTIC_MISSION_ENDPOINT.concat("/1"), HttpMethod.PUT, createJson(mission));
